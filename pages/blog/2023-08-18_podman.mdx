...
tags:
  ...
  - podman
  - guide
ogImage: https://github.com/danny-avila/LibreChat/assets/32828263/2f31b665-ea3e-41b0-b7cb-1e213cbe21d1
authorid: anon
---
...
Follow [this guide](../configuration/ai_setup.md) //TODO to populate the containers with the correct env values for various apis. There are other env values of interest that might be worth changing, documented within the env itself. Afterwords, edit the following lines in the `.env` file.
...
When using Podman for setting up LibreChat, you can also integrate the [`librechat.yaml` configuration file](../configuration/custom_config.md). //TODO
...
Any errors in this file might affect the functionality of LibreChat. For more information on configuring `librechat.yaml`, refer to the [configuration guide](../configuration/custom_config.md). //TODO
