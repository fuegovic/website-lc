...
tags:
  - ollama
  - guide
ogImage: https://github.com/danny-avila/LibreChat/assets/32828263/edad713a-c8b2-45a3-b559-7adf99245f4a
authorid: librechat
---
...
- See: [Docker Override](/docs/configuration/docker/docker_override)
...
Finally, use your `librechat.yaml` configuration file to add Ollama as a separate endpoint. Follow our [guide](./ai_endpoints.md) for a step-by-step walkthrough. //TODO
