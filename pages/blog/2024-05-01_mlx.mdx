...
tags:
  ...
  - guide
  - MLX
ogImage: https://github.com/danny-avila/LibreChat/assets/32828263/36e4377a-e779-49e2-a09b-37be1b5531b0
authorid: anon
---
...
To use MLX with LibreChat, you'll need to add it as a separate endpoint in the `librechat.yaml` configuration file. An example configuration for the Llama-3 model is provided. Follow the [Configuration file guide](./ai_endpoints.md) //TODO for more details.
