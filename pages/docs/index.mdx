...
<Cards num={3}>
  <Cards.Card href="/docs/tracing/overview" title="How tracing works" image arrow>
    ![Quickstart icon (rocket)](/images/cards/code.svg)
  </Cards.Card>
  <Cards.Card href="/docs/get-started" title="Quickstart" image arrow>
    ![Quickstart icon (rocket)](/images/cards/rocket.svg)
  </Cards.Card>
  <Cards.Card href="/docs/demo" title="Interactive demo" image arrow>
