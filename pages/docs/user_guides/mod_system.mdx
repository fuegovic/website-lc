...
- `Optional:{:hack}` File Upload limiting (configurable through [`librechat.yaml` config file](https://docs.librechat.ai/install/configuration/custom_config.html#rate-limiting))
//TODO:
