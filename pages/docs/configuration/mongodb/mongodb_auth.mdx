...
Example `docker-compose.override.yml` file using the [`librechat.yaml` config file](./custom_config.md), //TODO MongoDB with [authentication](#), and `mongo-express` for [managing your MongoDB database](/blog/2023-11-30_mongoexpress):
