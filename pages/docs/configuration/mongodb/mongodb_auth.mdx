...
For more info about the override file, please consult: [Docker Compose Override](https://nextra.librechat.cfd/docs/configuration/docker_override)
...
Example `docker-compose.override.yml` file using the [`librechat.yaml` config file](./custom_config.md), MongoDB with [authentication](#), and `mongo-express` for [managing your MongoDB database](../../features/manage_your_database.md):
