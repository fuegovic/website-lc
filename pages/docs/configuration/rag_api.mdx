...
**For further details, refer to the user guide provided here: [RAG API Configuration](/docs/user_guides/rag_api)**
...
As always, make these changes in your //TODOupdate URLs [Docker Compose Override File](../install/configuration/docker_override.md). You can find an example for exactly how to change the image in `docker-compose.override.yml.example` at the root of the project.
