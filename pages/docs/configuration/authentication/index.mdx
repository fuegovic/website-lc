...
<OptionTable
  options={[    
    ['ALLOW_EMAIL_LOGIN', 'boolean', 'Allow email login. Defaults to `true`.'],
    ['ALLOW_REGISTRATION', 'boolean', 'Allow registration. Defaults to `true`.'],
    ['ALLOW_SOCIAL_LOGIN', 'boolean', 'Allow social login. Defaults to `false`.'],
    ['ALLOW_SOCIAL_REGISTRATION', 'boolean', 'Allow social registration. Defaults to `false`.'],
  ]}
/>
...
<OptionTable
  options={[
    ['SESSION_EXPIRY', 'integer', 'Session expiry time in milliseconds. Defaults is (1000 * 60 * 15)'],
    ['REFRESH_TOKEN_EXPIRY', 'integer', 'Refresh token expiry time in milliseconds. Defaults (1000 * 60 * 60 * 24) * 7)'],
  ]}
/>
...
<OptionTable
  options={[    
    ['JWT_SECRET', 'string', 'Secret key for JSON Web Tokens. Required.'],
    ['JWT_REFRESH_SECRET', 'string', 'Secret key for refresh tokens. Required.'],
  ]}
/>
