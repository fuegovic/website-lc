...
see: [File Config Object Structure](#file-config-object-structure) //TODO
...
<OptionTable
  options={[
    ...
    ['allowedDomains', '', 'Specifies allowed domains for registration. [More info](#alloweddomains)', ''],
  ]}
/>
...
- [Registration Object Structure](#registration-object-structure) //TODO
...
see: [Interface Object Structure](#interface-object-structure) //TODO
...
see: [Model Specs Object Structure](#model-specs-object-structure) //TODO
...
see: [Full Custom Endpoint Object Structure](#custom-endpoint-object-structure)
see: [Full Azure OpenAI Endpoint Object Structure](#azure-openai-object-structure)
see: [Full Assistants Endpoint Object Structure](#assistants-endpoint-object-structure) //TODO