...
<Callout type="info" title="Dev Ressources" emoji="🧑‍💻">
  ...
  **branches**, begin with the official GitHub documentation: - [Getting Started - About
  ...
  understand our coding standards, see: - [Coding Conventions](/docs/development/conventions)
</Callout>
