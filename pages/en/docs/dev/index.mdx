---
title: Examples
description: Examples of various docs features.
---
import { 
  Tabs,
  Steps,
...
import { Carousel, Callout, Feature, Features } from '../../../../components'
import { Shadow, ResizableTextInput } from '../../../../components'
...
<Tabs items={['Example', 'Code']}>
  <Tabs.Tab>
    <Carousel autoplay animationDuration="1500" perView="3">
      <img src="https://github.com/danny-avila/LibreChat/assets/32828263/9b260f59-6acc-4fac-83b9-9d123d6b4a35" alt="Slide 1" />
      <img src="https://github.com/danny-avila/LibreChat/assets/32828263/d742c488-963a-4011-86f2-b6df184b70d1" alt="Slide 2" />
      <img src="https://github.com/danny-avila/LibreChat/assets/32828263/5a338731-eb95-41ea-8327-f5e78b8cc157" alt="Slide 3" />
    </Carousel>
  </Tabs.Tab>
...
<Tabs items={['Example', 'Code']}>
  ...
  And here's a factual button with Alert:
...
<Tabs items={['Example', 'Code']}>
  ...
  ```tsx copy filename="video"
    <video
      ...
      controls
    >
      <source src="../../../../public/video/example.mp4" />
    </video>
  ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['Example', 'Code']}>
  <Tabs.Tab>
    ...
    <Shadow mode="open">
      <h2>This is inside the Shadow DOM</h2>
      <p>Styles applied here will not affect the outer content.</p>
      <style>
        {`
          h2 { color: blue; }
          p { font-weight: bold; }
    ...
    This content is also outside the Shadow DOM.

  </Tabs.Tab>

  <Tabs.Tab>

  The `<Shadow>` component allows you to create a Shadow DOM, which encapsulates styles and content within its own isolated scope.
  
  ```jsx copy filename="shadow-dom"
  ...
  ```
  [<span style={{ fontSize: '0.8rem' }}>See `./components/utils/shadow.jsx` for Source Code</span>]()
...
This example demonstrates the usage of the `ResizableTextInput` component, which is a text input field that resizes its height automatically based on the content entered by the user.

To use the `ResizableTextInput` component, you simply need to import it and render it in your code, as shown in the example:

  ```tsx copy filename="resizable-text-input"
import { ResizableTextInput } from '../components';

<ResizableTextInput />
  ```
By default, the `ResizableTextInput` component renders a textarea element with the resizing functionality already implemented. You can customize the component by passing additional props or styling it with CSS classes as needed.
