   ...
   <div className="overlay">
      ...
      <h1 className={styles.headline}>
          <p className={styles.head}>
            <span></span>
            <span>
              <span className={styles.headlineOne}>{heroMap.headlineOne}</span><br className="max-md:_hidden" />
        ...
        <p className={styles.subtitle}>
          {heroMap.subtitleOne}<br className="max-md:_hidden" />
          {/* {heroMap.subtitleTwo}
          <br className="max-md:_hidden" />
        ...
        <div className={styles.actions}>
          <Link className={styles.cta} href={`/docs/intro`}>
