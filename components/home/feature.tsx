      ...
      <div className={`${styles.panel} ${styles['feature-table']}`}>
        <div className={styles['feature-plan']}>
          ...
          <ul className={styles['feature-desc']}>
            <li key='1' className={styles['feature-desc-item']}>Everything you need to know</li>
          </ul>
        </div>
        <div className={styles['feature-plan']}>
          <a href={"https://librechat.ai/blog"} target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
            <path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/><path d="M8 12h.01"/><path d="M12 12h.01"/><path d="M16 12h.01"/></svg>
            <h2 className={styles['feature-header']}>Blog</h2>
          </a>
          <ul className={styles['feature-desc']}>
            <li key='1' className={styles['feature-desc-item']}>Stay up to date with the latest news</li>
          </ul>
        </div>
      </div>
    </div>
