...
const Logo = (props: ComponentProps<'svg'>): ReactElement => (
  <svg viewBox="0 0 270.93 270.93" {...props}>
  <defs>
    <linearGradient id="LibreChat-docs_svg__a">
      <stop stopColor="#21facf" offset={0} />
      <stop stopColor="#0970ef" offset={1} />
    </linearGradient>
    <linearGradient
      id="LibreChat-docs_svg__d"
      x1={68.454}
      x2={198.59}
      y1={246.73}
      y2={96.35}
    ...
    <linearGradient
      id="LibreChat-docs_svg__c"
      x1={68.454}
      x2={198.59}
      y1={246.73}
      y2={96.35}
      gradientUnits="userSpaceOnUse"
      xlinkHref="#LibreChat-docs_svg__a"
    />
    <linearGradient
      id="LibreChat-docs_svg__e"
      x1={54.478}
      x2={192.1}
      y1={247.56}
      y2={9.809}
  ...
  <path
    ...
    fill="url(#LibreChat-docs_svg__e)"
  />
</svg>
)
